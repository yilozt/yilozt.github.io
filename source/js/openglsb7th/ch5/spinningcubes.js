window.addEventListener("load", () => {
  ...
  function render() {
    ...
    for (let i = 0; i < 24; i++) {
      ...
      mat4.translate(mv_mat, mv_mat, vec3.fromValues(0.0, 0.0, -6.0));
      mat4.rotateY(mv_mat, mv_mat, (time * 45) / 180 * Math.PI);
      mat4.rotateX(mv_mat, mv_mat, (time * 21) / 180 * Math.PI);

      mat4.translate(mv_mat, mv_mat,
                     vec3.fromValues(Math.sin(2.1 * f) * 2.0,
                                     Math.cos(1.7 * f) * 2.0,
